...
import { serverTimestamp,collection, addDoc, setDoc, getDoc, doc, updateDoc } from 'firebase/firestore';
import { getStorage, ref, getDownloadURL,list, uploadString } from "firebase/storage";
// import {useRecoilState} from "recoil"
...
function Modal() {
  ...
  return (
    ...
    onClose={setOpen}>
    <div className='flex items-end justify-center min-h-[800px] sm:min-h-screen pt-4 px-4
            ...
            sm:max-w-sm sm:w-full sm:p-6'>
                <div>
                    {selectedFile? (
                        ...
                        className="w-full object-contain cusor-pointer"
                    ...
                    <div className='mt-5 sm:mt-6'>
                        ...
                        focuus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:text-sm disabled:bg-gray-300
                        disabled:cusor-not-allowed hover:disabled:bg-gray-300'
                        onClick={uploadPost}>
